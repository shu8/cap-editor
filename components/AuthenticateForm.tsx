...
import { Button, Divider, Form, IconButton, Stack } from "rsuite";
...
// From https://uxwing.com/finger-print-icon/
...
export default function AuthenticateForm({
  ...
  const initUsernamelessLogin = async () => {
    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.authenticateForm}>
        {browserSupportsWebAuthn() && (
          <>
            <IconButton
              icon={<Icon as={FingerprintIcon} />}
              appearance="link"
              size="sm"
              onClick={handlePasskeyLogin}
            >
              <Trans>Login with your fingerprint, face, or PIN?</Trans>
            </IconButton>
        ...
        >
          <Stack spacing={10} justifyContent="center">
            <Form.Group>
              ...
              />
              <Form.HelpText>
                <Trans>You will be emailed a link to login.</Trans>
              </Form.HelpText>
            </Form.Group>
            <Form.Group>
