...
This should be an email address which receives verification requests when users attempt to connect to an Alerting Authority (inc. 'Other' AAs). This contact should have the capability and authorisation to verify whether the requesting user is part of an Alerting Authority.
